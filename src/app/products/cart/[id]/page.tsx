...
<div className='  md:h-[300px] md:w-[400px] overflow-hidden w-screen h-00px] '>

<div className=' flex max-md:flex-col max-md:items-center'>
<div className='md:h-[300px] md:w-[600px] h-[500px] w-[390px] bg-cover bg-center ' style={{backgroundImage:`url(/images/banners/${item.image})`}} id='cover'>
...
<div className='px-3 py-2 flex flex-col gap-10 -mr-5 max-md:justify-center max-md:mt-5 overflow-hidden'>
...
{/* product quantity */}
<div className='max-md:ml-20 max-md:mt- mb-20 md:h-[150px] w-[100px] flex items-center justify-center '>
...
{/* product total */}
<div className=' md:h-[150px] flex justify-center items-center w-[120px] max-md:hidden md:mr-6'>
...
<div className=''>
<h1 className='font-semibold text-xl  mb-3 text-[#371f96fd]'>Subtotal $ {item.price} </h1>
<h1 className='mb-3 text-lg font-semibold text-[#351f8d]'>Taxes and Shipping are calculated at Subtotal</h1>
<button className='px-4 py-3 bg-[#2d115a] hover:bg-[#352183da] duration-200 text-white font-light'>Check Out</button>
